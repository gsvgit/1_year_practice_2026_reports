...
\textbf{Целью работы является} реализация структуры данных \enquote{Множество} с автоматической балансировкой АВЛ-дерева, на основе которого оно написано, и оценка ее производительности.
